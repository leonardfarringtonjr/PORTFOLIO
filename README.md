...
G. PORTFOLIO SECTION
    ...
    * HOW TO SHOW DYNAMIC DATA FROM THE DB IN THE INPUT FIELD
        1. YOU PASS THE DATA FROM THE DB TO THE CONTROLLER
        2. THEN YOU STORE THAT DATA INTO A VAR
        3. YOU PASS THAT VAR TO THE VIEW
        4. YOU ACCESS THAT VAR WITHIN THE INPUT FIELD

        * YOU SHOULD SHOW THE DATA THAT THE USER WILL BE UPDATING WITHIN THE INPUT FIELD BEFORE THEY UPDATE IT

    * EDIT PAGES
        1. WHEN YOU UPDATE THE DATA FROM AN EDIT PAGE, THE FORM SHOULD BE SUBMITTED TO THE UPDATE METHOD OF THAT CONTROLLER

    * NEEDS A DYNAMIC PARAMETER FOR THE FOLLOWING ROUTE TO WORK / THIS ROUTE SUPPORTS THIS METHOD
    
        // DELETE -> admin/category/{category} -> admin.category.destroy

    * CONFIRM ALERT ON DELETE USING SWEETALERT

    * NETWORK ERROS
    
        // WHEN A LINK ISNT WORKING, OPEN THE CONSOLE, THEN GO TO NETWORK TAB, THEN THE RESPONSE TAB TO SEE WHAT THE ERROR IS

    * DATA TABLES

        1. AUTOMATICALLY PUT ALL ITEMS IN ORDER

            // orderBy(0)

        2. DELETE ALL EXTRA BUTTONS FROM THE TABLE

            // buttons([]);

    * EDIT/DELETE

        // ONLY EDIT NEEDS ITS OWN PAGE. DELETE NEEDS A NOTIFICATION BEFORE IT HAPPENS.

    * DYNAMIC PORTFOLIO

        1. FOR ALL THE CONTENT ON THE PAGE, YOU NEED AN INPUT FIELD

        2. CREATE THE CONTROLLER
        2. CREATE THE MODEL AND MIGRATIONS
        . REGISTER THE ROUTE
        . CREATE THE DATATABLE 
        . CREATE THE INDEX ROUTE -> TEST IT

        * CREATE ROUTES
            1. CREATE THE BUTTON ON THE INDEX PAGE
        ...
        * HOW TO DELETE DATA
            ...
            1.
            2. HOW TO DELETE THE IMAGE DATA FROM THE DB
                - CREATE A HELPER FN FOR IT

        * PORTFOLIO SECTIONS
            1. CREATE A NEW ROUTE -> NEW CONTROLLER -> NEW MODEL -> CREATE THE ROUTE IN WEB.PHP
            2. CREATE A NEW INDEX.BLADE
            3. TEST THE ROUTE
            4. ADD THE FORM'S COLUMNS TO THE MIGRATION
            5. ADD DATA TO THE CONTROLLER
                * VALIDATE
                * UPDATE OR CREATE
                * NOTIFY
                * REDIRECT
            6. PASS DYNAMIC DATA TO THE VIEW
                * IN THE INDEX METHOD, STORE THE MODEL INTO A VAR
...
Z. CHANGES FOR LATER
    ...
    1. YOUR NAME DOESN'T FIT -> INCREASE THE SIZE OF THE HERO IMAGE TEXT SECTION
